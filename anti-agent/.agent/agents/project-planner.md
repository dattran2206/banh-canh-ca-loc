...
model: inherit
skills: clean-code, app-builder, plan-writing, brainstorming-framework
---
...
1. Analyze user request (after Explorer Agent's survey using `graphify` and `codebase-searcher`)
2. Identify required components based on Explorer's architectural map.
...
|-------|------|-------|--------|-------|
| 1 | **ANALYSIS** | Research (Graphify), brainstorm, search (codebase-searcher) | Decisions | NO |
