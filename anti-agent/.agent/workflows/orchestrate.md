...
### PHASE 2: IMPLEMENTATION (Deep Execution vs Simple Parallel)

Are we building a full feature or just making simple edits?

| Task Complexity | Execution Strategy | Action |
|-----------------|--------------------|--------|
| **Deep Feature** | Sequential Pipelines | Invoke `/be-pro` fully, THEN invoke `/fe-pro` |
| **Simple Fix** | Parallel Groups | Invoke agents in parallel as below |

**Parallel Groups (For Simple Fixes Only):**
...
> For Deep Execution: NEVER RUN FE and BE in parallel. Backend must define the API contract first.
